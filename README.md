...
├── notebooks/              # Jupyter notebooks (code structure demos)
│   └── RAG_Demo.ipynb     # Code structure and usage notebook
...
- **Configurable**: Adjust log levels via logging configuration

### Reproducibility

Random seed setting ensures reproducible results:
- Seeds set for Python's random module, NumPy, and PyTorch
...
- **`src/utils.py`**: Utility functions for reproducibility (random seed setting)
