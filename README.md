...
- **Modular Design**: Separate concerns (vector DB, RAG logic, document loading)
...
This license does not grant permission to use trademarked names, logos, or other brand features. The project is provided "as-is" without warranties of any kind.
